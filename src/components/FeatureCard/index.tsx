      ...
      <div className="flex flex-col">
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              <div className="flex items-start rounded-xl bg-white p-4 shadow-lg">
                  <div className="grid h-12 w-12 items-center justify-center rounded-full border border-red-100 bg-red-50">
                  ...
                  <div className="ml-4">
                      <h2 className="font-semibold text-xl">99 Instituições</h2>
                  </div>
              </div>
              ...
              <div className="flex items-start rounded-xl bg-white p-4 shadow-lg">
                  ...
                  <div className="ml-4">
                      <h2 className="font-semibold text-xl">120 Usuários</h2>
                  </div>
              </div>
              <div className="flex items-start rounded-xl bg-white p-4 shadow-lg">
                  ...
                  <div className="ml-4">
                      <h2 className="font-semibold text-xl">548 Eventos</h2>
                  </div>
              </div>
          </div>
      </div>
